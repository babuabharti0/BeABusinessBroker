...
import lenKrickPhotoFallback from "./images/LenKrick'sPhoto.jpg";
import fastStartLogoFallback from './images3/FastStart.png';
import ibbaLogoFallback from './images/IBBALogo.png';
import pricePointLogoFallback from './images3/PricePointLogoWhiteBackground.png';
import accreditedLogoFallback from './images3/AccreditedSeniorBusinessBrokerLogo-New.png';
import videoFrameFallback from './images2/FastStartCourseScreenshot.png';
import pricePointReportCoverFallback from './images4/PricePointReportCoverScreenshot.png';
            ...
            <div className="p-6 flex flex-col justify-between flex-1">
              <div className="grid grid-cols-1 sm:grid-cols-12 gap-5 items-center flex-1">
                ...
                <div className="sm:col-span-7 flex items-center justify-center bg-white p-2 rounded-lg border border-slate-200/80 h-full min-h-[500px] overflow-hidden">
                  <img loading="lazy" src="src/images4/PricePointReportCoverScreenshot.png" 
      ...
      <section className="mt-10 w-full">
        ...
        <div className="bg-[#0B1D3A] text-white h-auto lg:h-[99px] py-4 lg:py-0 px-3 sm:px-6 lg:px-8 xl:px-10 shadow-lg flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6 w-full">
          ...
          <div className="flex items-center justify-end gap-3 md:gap-4 shrink-0">
            ...
            <button className="border-2 border-white hover:bg-white/10 text-white font-bold px-[47px] py-2 md:py-2.5 rounded-lg text-xs md:text-sm uppercase tracking-wide transition-all cursor-pointer whitespace-nowrap">
              REQUEST INFO
            </button>
          </div>
        </div>
