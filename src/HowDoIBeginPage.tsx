...
import fastStartLogo from './images2/FastStart.jpg';
import warrenBuffettImg from './images2/WarrenBuffetQuote.png';
import accreditationBadge from './images2/AccreditedSeniorBusinessBrokerLogo-New.png';
import lenKrickImg from "./images2/LenKrick'sPhoto.jpg";
import fastStartCourseScreenshot from './images2/FastStartCourseScreenshot.png';
import bookImg from './images2/book.png';
import checkImg from './images2/check.png';
import iconImg from './images2/_Icon.png';
import bagImg from './images2/bag.png';
import playImg from './images2/play.png';
import firstImg from './images2/first.png';
import calImg from './images2/cal.png';
import personImg from './images2/person.png';
import sirImg from './images2/sir.png';
import magImg from './images2/mag.png';
import handsImg from './images2/hands.png';
import stolenImg from './images2/stolen.png';
import funnelImg from './images2/funnel.png';
import hdgfImg from './images2/hdgf.png';
import hornImg from './images2/horn.png';
import hfhImg from './images2/hfh.png';
import menImg from './images2/men.png';
import gfhdImg from './images2/gfhd.png';
import hfgshImg from './images2/hfgsh.png';
import gfgsggiImg from './images2/gfgsggi.png';
import sssssImg from './images2/sssss.png';
      ...
      <main className="w-full">
        ...
        <section className="bg-[#02102C] text-white py-14 px-3 sm:px-6 lg:px-8 xl:px-10 relative overflow-hidden">
          <div className="w-full flex flex-col lg:flex-row justify-between items-center gap-10 lg:gap-0">
            ...
            {/* Left Column */}
            <div className="w-full flex-1 space-y-6 pr-0 lg:pr-10 xl:pr-16 relative z-10">
              <h1 className="text-4xl sm:text-5xl lg:text-[67px] lg:mr-[299px] ml-0 font-black leading-tight tracking-tight text-white">
                <span className="block">FIRMS ARE</span>
                <span className="block lg:-mr-[200px]">LOOKING FOR YOU</span>
              </h1>
            ...
            <div className="w-full flex-1 flex justify-center lg:justify-end items-center pl-0 lg:pl-10 xl:pl-16 lg:static">
              <div className="relative w-[80%] lg:absolute lg:inset-y-0 lg:right-0 lg:w-[40vw] overflow-hidden lg:pointer-events-none z-0 transform scale-[0.8] lg:origin-right origin-center">
                <img 
                  src={warrenBuffettImg} 
                  alt="Warren Buffett Quote" 
                  className="w-full h-auto lg:h-full lg:object-cover lg:object-center object-contain" 
                />
              </div>
            </div>
          </div>
        ...
        <div className="w-full mx-auto px-3 sm:px-6 lg:px-8 xl:px-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="lg:col-span-6 bg-white border border-slate-200 rounded-2xl p-8 shadow-sm relative flex flex-col justify-between">
              <h3 className="font-extrabold text-[#0B1D3A] mb-2 ml-[100px] text-[27px]">
                Why Faststart was created
              </h3>
              <div className="text-[#FF4500] text-7xl font-serif leading-none -mb-4 select-none mt-0">
                “
              </div>
              <blockquote className="text-slate-700 leading-relaxed my-4 relative z-10 font-bold not-italic text-[19px] ml-[19px] mr-[23px]">
              ...
              <div className="pt-4 border-t border-slate-100">
                <p className="text-sm font-bold text-[#0B1D3A] ml-[450px]">
                  — Len Krick, MBA
                </p>
              </div>
            </div>
