...
import logoImgFallback from './images/BeABusinessBrokerLogo.png';
import lenKrickPhotoFallback from "./images5/LenKrick'sPhoto.jpg";
import ibbaLogoFallback from './images5/IBBALogo.png';
import cbiLogoFallback from "./images5/IBBA'sCBIlogo.png";
import mamiLogoFallback from "./images5/IBBA'sM&AMILogo.jpg";
import tomWestFallback from './images5/TomWestAward.jpg';
import hallOfFameFallback from './images5/IBBAHallofFameAward.jpg';
import clarkBellFallback from './images5/ClarkBell.png';
import fastStartFallback from './images5/FastStart.jpg';
import pricePointFallback from './images5/PricePointLogo.png';
import peopleFallback from './images5/people.png';
...
export default function AboutPage({ onNavigate }: AboutPageProps) {
  ...
  return (
    <div className="min-h-screen font-sans bg-[#F8FAFC] text-slate-800 w-full overflow-x-hidden max-w-full">
      ...
      <section className="bg-[#0B1D3A] overflow-hidden relative text-white py-12 px-6 lg:px-12 w-full lg:h-[780px]">
        <div className="max-w-[1615px] mx-auto flex flex-col lg:flex-row items-center justify-between gap-8 relative z-10 h-full">
          ...
          <div className="w-full lg:w-[40%] space-y-4">
            ...
            <div className="p-4 rounded-xl bg-slate-900/80 border border-[#FF4500]/40 shadow-inner">
              <p className="text-[#FF4500] font-bold text-[17px] md:text-[19px] leading-snug">
          ...
          <div className="w-full lg:w-[389.656px] lg:h-[550px] pl-0 flex justify-center items-center overflow-visible">
            <div className="relative h-full w-auto bg-transparent rounded-xl overflow-visible animate-pulse">
              <img 
                ...
                loading="eager"
                fetchPriority="high"
                className="h-[550px] w-auto object-contain mx-auto mix-blend-lighten scale-150 transition-all duration-700 ease-in-out opacity-0"
                style={{
          ...
          <div className="w-full lg:w-[32%] flex flex-col sm:flex-row items-center justify-center lg:justify-end gap-3 overflow-visible">
            <div className="relative h-[560px] sm:h-[640px] lg:h-[700px] bg-transparent rounded-xl overflow-visible animate-pulse">
              <img 
                src="https://images.unsplash.com/photo-1556761175-5973dc0f32d7?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" 
                ...
                loading="eager"
                fetchPriority="high"
                className="h-[560px] sm:h-[640px] lg:h-[700px] w-auto object-contain mix-blend-screen scale-200 transition-all duration-700 ease-in-out opacity-0"
                style={{
                  maskImage: 'linear-gradient(to bottom, transparent 0px, black 40px, black calc(100% - 40px), transparent 100%), linear-gradient(to right, transparent 0px, black 40px, black calc(100% - 40px), transparent 100%)',
                  WebkitMaskImage: 'linear-gradient(to bottom, transparent 0px, black 40px, black calc(100% - 40px), transparent 100%), linear-gradient(to right, transparent 0px, black 40px, black calc(100% - 40px), transparent 100%)',
                  maskComposite: 'intersect',
            ...
            <div className="relative h-[560px] sm:h-[640px] lg:h-[700px] bg-transparent rounded-xl overflow-visible animate-pulse">
              <img 
                src="src/images5/IBBAHallofFameAward.jpg" 
      ...
      <section className="max-w-[1615px] mx-auto px-6 lg:px-12 py-10 w-full">
      ...
      <section className="max-w-[1615px] mx-auto px-6 lg:px-12 w-full">
        <div className="bg-orange-50/60 border border-orange-200 rounded-xl p-6 flex flex-col md:flex-row items-center justify-between gap-6 my-8 shadow-xs" style={{ marginRight: '100px', marginLeft: '100px' }}>
      ...
      <section className="max-w-[1615px] mx-auto px-6 lg:px-12 w-full mb-12">
          ...
          <div className="flex flex-col justify-between">
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  <div className="shrink-0">
                    <img loading="lazy" src="src/images5/mba.png" 
                      alt="MBA Badge" 
                      className="w-40 h-40 object-contain"
                      onError={(e) => { e.currentTarget.src = cbiLogoFallback; }} 
                    />
          ...
          <div className="flex flex-col justify-between">
            <div>
              ...
              <div className="space-y-6">
                ...
                {/* Block 1: FastStart */}
                <div className="flex items-center gap-4">
                  <div className="shrink-0 w-96 flex items-center justify-center">
                    <img loading="lazy" src={fastStartFallback} 
                      alt="FastStart Logo" 
                      className="w-full object-contain"
                      style={{ height: '150px', width: '500px', marginTop: '24px' }}
                      onError={(e) => { e.currentTarget.src = fastStartFallback; }} 
                    />
                  </div>
                  <div className="flex-1 text-right">
                    <p 
                      className="text-xs sm:text-sm text-[#0B1D3A] leading-relaxed text-left"
                      style={{ textAlign: 'left', marginTop: '42px', marginLeft: '-31px', marginRight: '100px' }}
                    >
                ...
                <div className="flex items-center gap-4">
                  <div className="shrink-0 w-96 flex items-center justify-center">
                    <img loading="lazy" src="https://images.unsplash.com/photo-1556761175-5973dc0f32d7?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" 
                      alt="PricePoint Logo" 
                      className="w-full object-contain pt-[130px]"
                  ...
                  <div className="flex-1 text-right">
                    <p 
                      className="text-xs sm:text-sm text-[#0B1D3A] leading-relaxed text-left"
                      style={{ textAlign: 'left', marginTop: '80px', marginLeft: '-27px', marginRight: '100px' }}
                    >
                ...
                <div className="flex items-center gap-4">
                  <div className="shrink-0 w-64 flex items-center justify-center">
                    <img loading="lazy" src="src/images5/people.png" 
                      alt="Coaching People Logo" 
                      className="w-full object-contain"
                      style={{ marginRight: '25px', marginLeft: '-130px' }}
                      onError={(e) => { e.currentTarget.src = peopleFallback; }} 
                    />
                  </div>
                  <div className="flex-1 text-right" style={{ marginRight: '61px', marginLeft: '-39px' }}>
                    <h3 className="font-extrabold text-[#0B1D3A] text-xs sm:text-sm uppercase tracking-wide" style={{ marginRight: '20px' }}>
                      OVER 400 BUSINESS BROKERS COACHED
                    </h3>
                    <p 
                      className="text-xs sm:text-sm text-[#0B1D3A] mt-1 leading-relaxed text-left"
      ...
      <section className="max-w-[1615px] mx-auto px-6 lg:px-12 w-full my-8">
        <div className="border border-orange-200 rounded-2xl p-6 bg-white shadow-xs">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            
            {/* Left Side: Testimonial Card */}
            <div className="lg:col-span-6 bg-slate-50 rounded-xl border border-slate-200 overflow-hidden flex flex-col sm:flex-row">
              ...
              <div className="p-6 flex-1 space-y-4 flex flex-col justify-center text-center">
                ...
                <blockquote className="text-xs sm:text-sm text-[#0B1D3A] italic leading-relaxed text-center" style={{ fontWeight: 'bold', fontSize: '16px' }}>
                  "I entered business brokerage with the guidance, training, and systems provided through FastStart. In my first year, I generated approximately $699,000 in transaction fees. The step-by-step approach helped me avoid costly mistakes and focus on activities that actually produce results."
                </blockquote>
      ...
      <section className="w-full">
        <div className="bg-[#0B1D3A] text-white py-4 px-6 lg:px-12 flex flex-col md:flex-row items-center justify-between gap-6 shadow-lg w-full">
