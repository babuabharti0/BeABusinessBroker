...
import logoImgFallback from './images5/BeABusinessBrokerLogo.webp';
import ibbaLogoFallback from './images5/IBBALogo.webp';
import camDupreeImg from './images6/Cam Dupree.webp';
import frankImg from './images6/frank.webp';
import josephImg from './images6/joseph.webp';
import jamieImg from './images6/jamie.webp';
import pennyImg from './images6/penny.webp';
import marcoImg from './images6/marco.webp';
import christopherImg from './images6/christopher.webp';
import nathanielImg from './images6/nathaniel.webp';
import billImg from './images6/bill.webp';
import maryImg from './images6/mary.webp';
import edImg from './images6/ed.webp';
    ...
    <div className="min-h-screen font-sans bg-[#F8FAFC] text-slate-800 w-full overflow-x-hidden max-w-full">
      ...
      >
        <div className="w-full max-w-none px-4 sm:px-8 lg:px-12">
          <h1 className="text-[26px] sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black text-center tracking-tight mb-4 text-[#0B1D3A] whitespace-normal md:whitespace-nowrap">
            ...
            <div className="lg:col-span-3 bg-[#061224] p-8 flex flex-col justify-center space-y-6 border-t lg:border-t-0 lg:border-l border-slate-700">
              ...
              <div className="flex items-center gap-4 pb-4 border-b border-slate-700/80">
                ...
                <div>
                  ...
                  <div className="text-gray-300 font-bold tracking-wider mt-1 text-lg lg:text-[30px]">IN FEES</div>
                </div>
              </div>
        ...
        <div className="w-full max-w-none px-4 sm:px-8 lg:px-12">
            ...
            <div className="lg:col-span-2 bg-[#0B1D3A] rounded-xl p-8 flex items-center gap-6 shadow-xl relative overflow-hidden">
              ...
              <div>
                ...
                <p className="text-gray-300 text-xs italic leading-relaxed">
                  “I closed a $1.6 million deal less than two months after I completed the FastStart Broker Training Program, and earned a fee that was 160 times the price of the program. Talk about a “return on investment!”
                </p>
              </div>
            </div>
          ...
          <div className="w-[calc(100%+2rem)] sm:w-[calc(100%+4rem)] lg:w-[calc(100%+6rem)] -mx-4 sm:-mx-8 lg:-mx-12 bg-[#0B1D3A] rounded-none flex flex-col md:flex-row items-center justify-between px-8 sm:px-12 lg:px-20 py-8 md:py-12 mb-16 shadow-xl">
            ...
            <a 
              ...
              className="bg-[#FF4500] hover:bg-orange-600 transition-colors text-white font-bold text-lg px-8 py-4 rounded-xl shadow-lg mt-6 md:mt-0 whitespace-nowrap flex items-center justify-center cursor-pointer"
            >
