import logoImg from './images/BeABusinessBrokerLogo.webp';
import clarkImg from './images/ClarkBell.webp';
import fastStartImg from './images/FastStart.webp';
import ibbaLogo from './images/IBBALogo.webp';
import lenKrickImg from "./images/LenKrick'sPhoto.webp";
import maLogo from './images/M&ASourceLogo.webp';
import buffettImg from './images/WarrenBuffetQuote.webp';
import meetingImg from './images/meeting.webp';
import chatBgImg from './images/Chat.webp';
...
import icon05 from './images/icon05.webp';
import icon06 from './images/icon06.webp';
...
export default function HomePage({ onNavigate }: HomePageProps) {
  ...
  return (
    <div className="w-full max-w-full overflow-x-hidden min-h-screen font-sans bg-white">
      ...
      <main className="w-full">
        ...
        >
          <div className="relative z-10 flex flex-col gap-6 lg:flex-row lg:items-center w-full max-w-none">
            ...
            <div className="max-w-3xl relative w-full lg:w-1/2">
              <div className="relative z-10 lg:w-[90%] pr-4 lg:pr-0">
                <h1 className="text-3xl sm:text-4xl lg:text-6xl xl:text-[67px] font-black mb-3 leading-tight">
                  Why Become a Business Broker?
                </h1>
                <p className="text-xl lg:text-2xl mb-8 font-medium text-slate-200 w-full lg:max-w-[666px]">
                  A Career with Unlimited Income Potential, Professional Freedom, and Long-Term Opportunity.
                </p>
                <div className="bg-white text-gray-900 rounded-lg p-6 shadow-xl border-l-8 border-[#FF4A00] flex items-start gap-4 w-full lg:max-w-[575px]">
            ...
            <div className="flex justify-center lg:justify-end w-full lg:w-1/2 p-4 sm:p-6 lg:p-0">
              <div className="border-2 border-[#FBBF24] rounded-lg relative w-full lg:max-w-[574px] bg-slate-800/50 animate-pulse overflow-hidden ml-0 lg:-ml-[100px]">
                <img 
                  src={buffettImg} 
                  alt="Warren Buffett" 
                  width="553" 
          ...
          {/* Bottom Ribbon */}
          <div className="absolute bottom-0 left-0 z-10 bg-black/60 w-full py-4 flex flex-col sm:flex-col lg:flex-row gap-3 sm:gap-0 justify-between items-center px-4 sm:px-12 lg:px-16 text-[#FBBF24] font-bold uppercase text-xs sm:text-sm border-t border-gray-800 shadow-inner">
        ...
        <section className="py-8 lg:py-16 px-4 sm:px-6 lg:px-8 xl:px-10 bg-white grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 w-full max-w-none">
          ...
          <div className="lg:col-span-4 w-full text-center border-2 border-[#F57E45] rounded-xl p-6 shadow-sm bg-white flex flex-col justify-between">
            <div>
              <h2 className="text-[#1E3A8A] font-bold text-[21px]">TYPICAL TRANSACTION FEES</h2>
              <div className="text-3xl sm:text-4xl lg:text-6xl text-[#F57E45] font-extrabold my-2">10% - 12%</div>
        ...
        <section className="py-12 bg-gray-50 text-center px-4 sm:px-6 lg:px-8 xl:px-10 w-full">
          <div className="w-full max-w-none">
            <h2 className="text-[#1E3A8A] text-xl sm:text-2xl lg:text-2xl font-bold">Who Succeeds as a Business Broker?</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-3 sm:gap-4 lg:gap-5 mt-8 w-full">
              <div className="bg-white p-5 border border-gray-200 rounded-lg shadow-sm flex flex-col items-center hover:shadow-md transition-shadow h-full w-full text-center">
                ...
                <h3 className="font-bold text-[#1E3A8A] mb-2 text-base sm:text-lg lg:text-[16px] leading-tight">Commercial Real Estate Brokers</h3>
              ...
              <div className="bg-white p-5 border border-gray-200 rounded-lg shadow-sm flex flex-col items-center hover:shadow-md transition-shadow h-full w-full text-center">
                ...
                <h3 className="font-bold text-[#1E3A8A] mb-2 text-base sm:text-lg lg:text-[16px] leading-tight">Business Coaches & Consultants</h3>
              ...
              <div className="bg-white p-5 border border-gray-200 rounded-lg shadow-sm flex flex-col items-center hover:shadow-md transition-shadow h-full w-full text-center">
                ...
                <h3 className="font-bold text-[#1E3A8A] mb-2 text-base sm:text-lg lg:text-[16px] leading-tight">Corporate Professionals & Career Changers</h3>
              ...
              <div className="bg-white p-5 border border-gray-200 rounded-lg shadow-sm flex flex-col items-center hover:shadow-md transition-shadow h-full w-full text-center">
                ...
                <h3 className="font-bold text-[#1E3A8A] mb-2 text-base sm:text-lg lg:text-[16px] leading-tight">Financial Planners</h3>
              ...
              <div className="bg-white p-5 border border-gray-200 rounded-lg shadow-sm flex flex-col items-center hover:shadow-md transition-shadow h-full w-full text-center">
                ...
                <h3 className="font-bold text-[#1E3A8A] mb-2 text-base sm:text-lg lg:text-[16px] leading-tight">Prior Business Owners</h3>
              ...
              <div className="bg-white p-5 border border-gray-200 rounded-lg shadow-sm flex flex-col items-center hover:shadow-md transition-shadow h-full w-full text-center">
                ...
                <h3 className="font-bold text-[#1E3A8A] mb-2 text-base sm:text-lg lg:text-[16px] leading-tight">Bankers, Franchise Pros, Sales Execs & More</h3>
        ...
        <div className="lg:col-span-6 flex flex-col h-full w-full">
          <div className="border border-gray-200 rounded-lg py-5 px-6 bg-gray-50/50 shadow-sm flex flex-col justify-between flex-1 w-full min-h-[280px]">
            <div>
              <h2 className="text-[#1E3A8A] font-bold text-xl sm:text-2xl lg:text-[30px] uppercase mb-2">YOUR INCOME POTENTIAL</h2>
            ...
            <div className="overflow-x-auto pb-2">
              <div className="flex items-stretch h-36 sm:h-40 w-full min-w-0 lg:min-w-[500px] relative mb-2">
                {/* Y-Axis Column */}
            ...
            {/* X-Axis Labels Row */}
            <div className="flex items-center pl-[85px] justify-around text-xs font-bold text-gray-700 mb-3 w-full min-w-0 lg:min-w-[500px]">
        ...
        <div className="lg:col-span-6 flex flex-col h-full w-full">
          <div className="border border-gray-200 rounded-lg p-6 bg-white shadow-sm flex flex-col justify-between flex-1 w-full gap-6">
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col sm:flex-col lg:flex-row gap-6 items-center sm:items-start justify-between">
      ...
      <section className="py-8 lg:py-12 bg-white text-center px-3 sm:px-6 lg:px-8 xl:px-10 border-t border-gray-100">
        <div className="w-full max-w-none">
          <h2 className="text-[#1E3A8A] font-bold text-xl sm:text-2xl lg:text-[30px]">WHAT DOES A BUSINESS BROKER ACTUALLY DO?</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:flex lg:justify-between lg:items-stretch mt-8 gap-6 lg:gap-2 relative">
            ...
            <div className="flex flex-col items-center flex-1 justify-start">
              ...
              <p className="text-gray-500 font-bold text-base sm:text-lg lg:text-[16px]">Understand their goals and determine if a sale is the best option for the market.</p>
            </div>
            ...
            <div className="flex flex-col items-center flex-1 justify-start">
              ...
              <p className="text-gray-500 font-bold text-base sm:text-lg lg:text-[16px]">Analyze financials, market position, and intangible factors to determine value.</p>
            </div>
            ...
            <div className="flex flex-col items-center flex-1 justify-start">
              ...
              <p className="text-gray-500 font-bold text-base sm:text-lg lg:text-[16px]">Create a confidential information package that highlights the business opportunity.</p>
            </div>
            ...
            <div className="flex flex-col items-center flex-1 justify-start">
              ...
              <p className="text-gray-500 font-bold text-base sm:text-lg lg:text-[16px]">Market the business online and personally to pre-qualified buyers.</p>
            </div>
            ...
            <div className="flex flex-col items-center flex-1 justify-start">
              ...
              <p className="text-gray-500 font-bold text-base sm:text-lg lg:text-[16px]">Guide both parties through due diligence to keep the process moving forward.</p>
            </div>
            ...
            <div className="flex flex-col items-center flex-1 justify-start">
              ...
              <p className="text-gray-500 font-bold text-base sm:text-lg lg:text-[16px]">Work with attorneys, CPAs, and lenders to ensure a smooth closing.</p>
            </div>
            ...
            <div className="flex flex-col items-center flex-1 justify-start">
              ...
              <p className="text-gray-500 font-bold text-base sm:text-lg lg:text-[16px]">Help ensure a successful handoff so the business continues to thrive.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-16 bg-gray-50 px-3 sm:px-6 lg:px-8 xl:px-10">
        <div className="relative w-full max-w-none grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 items-stretch">
          ...
          <div className="bg-[#0A1931] text-white p-4 sm:p-5 rounded-2xl shadow-xl flex flex-col xl:flex-row items-center gap-4 h-full">
            ...
            <div className="w-full lg:w-[345px] shrink-0 mt-4 xl:mt-0 flex justify-center xl:justify-start">
              <img src={meetingImg} alt="Meeting" loading="lazy" decoding="async" className="w-full lg:max-w-[345px] h-auto ml-0 object-contain rounded-xl shadow-xl" />
            </div>
          </div>

          {/* Right Column Card */}
          <div className="bg-white p-4 sm:p-5 rounded-2xl shadow-xl border border-gray-100 flex flex-col sm:flex-col lg:flex-row gap-4 items-center h-full text-gray-900 justify-between">
            {/* Text Info */}
            <div className="flex-1 min-w-0 shrink-0 flex flex-col justify-between h-full">
              <div>
            ...
            <div className="w-full lg:w-[340px] shrink-0 relative flex justify-center items-end self-end">
              <img 
                src={lenKrickImg} 
                alt="Len Krick" 
                width="336"
      ...
      <section className="bg-[#071224] text-center py-8 px-4 sm:px-6 border-t border-gray-800">
        ...
        <a 
          ...
          className="bg-[#FF4A00] text-white font-extrabold px-6 py-4 rounded-md text-lg inline-block w-full sm:w-auto text-center hover:bg-[#e04100] transition-colors cursor-pointer"
        >
